...
//******************************************************************
//  Android animated Snowman with onDown() gesture and Toast message
//******************************************************************
...
public class SnowmanGestureWithToastView extends View {
   ...
   public SnowmanGestureWithToastView(Context context) {
      super(context);
   ...
   private class GestureListener extends SimpleOnGestureListener {
      ...
      public boolean onDown(MotionEvent e) { // only event handled
         waveOn = !waveOn;
         String message = (waveOn) ? "Dancing turned on!" :
                                     "Dancing turned off!";
