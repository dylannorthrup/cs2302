...
//******************************************************************
//  Android animated Snowman controlled by onDown() gesture
//******************************************************************
...
public class SnowmanOneGestureView extends View {
  ...
  public SnowmanOneGestureView(Context context) {
    super(context);

    // creating new gesture detector
    gestureDetector = new GestureDetector(context, new GestureListener());

    timer = new Timer();    // Instantiate the timer
  ...
  public boolean onTouchEvent(MotionEvent event) {
    ...
    //     waveOn = !waveOn;
    //     return true;
    // More complicated, but better way to do it
  ...
  private class GestureListener extends SimpleOnGestureListener {
    @Override
    public boolean onDown(MotionEvent e) { // only event handled
      waveOn = !waveOn;
      return true;
    }
    @Override
