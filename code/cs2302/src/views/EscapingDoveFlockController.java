 ...
 * simulation.
 */
public class EscapingDoveFlockController extends JFrame implements ActionListener {
  ...
  EscapingDoveFlockView simulatorPanel;
  
  // variables for handling and storing user input
  static int doveAmt = 10;
  static double doveScale = 0.4;
  static boolean sameDirection = false;

  // no-argument constructor
  public EscapingDoveFlockController() {
    setSize (WIDTH, HEIGHT);
    setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
    setTitle ("Escaping Dove Flock Simulator");
    ...
    simulatorPanel = new EscapingDoveFlockView(doveAmt, doveScale, sameDirection);
...
//    sameDirection = Boolean.parseBoolean(answer3);
    ...
    new EscapingDoveFlockController();
  }
}