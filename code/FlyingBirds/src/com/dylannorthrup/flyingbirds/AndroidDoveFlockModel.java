...
public class AndroidDoveFlockModel extends AndroidDove {
  ...
  public final double FLOCKRADIUS = 150;    // The radius that a flock extends to for 1.0 ratio
  ...
  public final double dimRatio;             // The dove's dimension ratio
  public final double flockRadius;          // The actual radius that a flock extends to
  ...
  /**
   * FlockingAndroidDove no arg constructor
   */ 
  ...
  /**
   * FlockingAndroidDove constructor
   * 
      ...
      int initXOff, int initYOff, double ratio)
  {
    ...
    this.dimRatio = ratio; 
    this.flockRadius = (int)(this.FLOCKRADIUS * ratio);
    this.tooClose = Math.min(this.imageWidth(),this.imageHeight()) * (3.0 / 4.0);
